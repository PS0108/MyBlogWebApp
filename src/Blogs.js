        ...
        return (
            <div className="column left">
                <div className="innerrow">
                    <p><h1><em><NavLink to="/BlogOne" className="ul_c">What Is Latency and Why Is it Important?</NavLink></em></h1></p>
                    <p>04/15/2020</p>
                ...
                <div className="innerrow">
                    <p><h1><em><NavLink to="/BlogTwo" className="ul_c">How Is Latency Characterized?</NavLink></em></h1></p>
                    <p>04/15/2020</p>
                ...
                <div className="innerrow">
                        <p><h1><em><NavLink to="/BlogThree" className="ul_c">What Contributes to Latency?</NavLink></em></h1></p>
                        <p>04/15/2020</p>
                        <div className="innercols">
